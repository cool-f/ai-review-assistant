...
class Course(Base):
    ...
    term: Mapped[str] = mapped_column(String(128), nullable=False, default="")
    ...
    coursewares = relationship(
        "Courseware", back_populates="course", cascade="all, delete-orphan"
    )
    ...
    chat_sessions = relationship(
        "ChatSession", back_populates="course", cascade="all, delete-orphan"
    )
...
class Courseware(Base):
    ...
    knowledge_status: Mapped[str] = mapped_column(String(32), nullable=False, default="pending")
    embedding_status: Mapped[str] = mapped_column(String(32), nullable=False, default="pending")
    linking_status: Mapped[str] = mapped_column(String(32), nullable=False, default="pending")
    ...
    # ── 关系 ──────────────────────────────────
    course = relationship("Course", back_populates="coursewares")
...
class KnowledgePoint(Base):
    ...
    indexing_status: Mapped[str] = mapped_column(String(32), nullable=False, default="completed")
...
class ChatRequest(Base):
    ...
    __table_args__ = (
        ...
        Index("ix_chat_requests_status", "status"),
    )
...
class Folder(Base):
    ...
    __table_args__ = (
        ...
        Index("ix_folders_course_id", "course_id"),
    )
...
class TokenUsageLog(Base):
    ...
    purpose: Mapped[str] = mapped_column(String(64), nullable=False, default="unspecified")
    ...
    course_id: Mapped[str | None] = mapped_column(
        UUID(as_uuid=False), ForeignKey("courses.id", ondelete="SET NULL"), nullable=True
    )
    ...
    __table_args__ = (
        ...
        Index("ix_token_usage_logs_purpose", "purpose"),
        Index("ix_token_usage_logs_course_id", "course_id"),
...
class PracticeAttempt(Base):
    ...
    counted_for_progress: Mapped[bool] = mapped_column(Boolean, nullable=False, default=False)
    created_at: Mapped[datetime] = mapped_column(
        DateTime(timezone=True), nullable=False, default=utcnow
    )
    ...
    __table_args__ = (
        ...
        Index("ix_practice_attempts_created_at", "created_at"),
    )
