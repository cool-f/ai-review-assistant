...
from review_assistant.infrastructure.persistence.models import Courseware, KnowledgePoint, Example
from review_assistant.interfaces.http.schemas.example import ExampleResponse, ExampleListResponse
