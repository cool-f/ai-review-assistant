...
def get_ai_client(
    ...
    if resolved_provider == "anthropic":
        from backend.services.providers.anthropic import AnthropicClient
    ...
    # ── OpenAI ─────────────────────────────────────────
        ...
        from backend.services.providers.openai import OpenAIClient
    ...
    # ── 通义千问 (DashScope) ────────────────────────
        ...
        from backend.services.providers.qwen import QwenClient
    ...
    # ── DeepSeek ──────────────────────────────────────
        ...
        from backend.services.providers.deepseek import DeepSeekClient
