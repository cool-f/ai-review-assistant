...
from backend.services.kp_matcher import KPMatcher
...
class HomeworkService:
    ...
    async def batch_solve(self, homework_id: str):
        ...
        try:
            ...
            if solved:
                async for match_event in self._match_and_link(solved):
                    yield match_event
            ...
            if not completed_normally:
                ...
                await self._update_homework_status(
                    homework_id, "failed", "SSE连接中断，解答过程未完成"
                )
    ...
    async def _match_and_link(
        ...
        for sol in solutions:
            ...
            try:
                matches = await matcher.match(combined_text)
